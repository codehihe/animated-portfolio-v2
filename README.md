...
| **GitHub API**         | Dynamic project fetching & display   |
...
2. **Connect your GitHub** — Link your GitHub username in `Work.tsx` to auto-display your projects dynamically.
3. **Resume Download** — Add your resume PDF link in `SocialIcons.tsx` for easy access.
4. **Add your character** — Drop in your custom 3D or 2D character to personalize the vibe
5. **Swap colors/fonts** — Tweak the CSS variables to match your aesthetic
